    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div>
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <img src={kiwify_logo} alt="Kiwify" className="mx-auto h-12 w-auto" />
              ...
              <label className="relative flex items-start mt-2">
                <div className="flex items-center h-5">
                  <input
                    ...
                    onChange={handleChange}
                    className={`form-checkbox h-4 w-4 text-indigo-600 transition duration-150 ease-in-out cursor-pointer ${errors.terms_check && "border-red-500"}`}
                  ></input>
                  </div>
                  <div className="ml-2 text-sm leading-5">
                    ...
                    {errors.terms_check && <div className="text-red-500 border-b-0">{errors.terms_check}</div>}
                  </div>
              </label>
            </div>
            {/* Submit button */}
